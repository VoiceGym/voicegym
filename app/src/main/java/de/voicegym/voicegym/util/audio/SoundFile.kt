...
private constructor() {
        ...
        while (true) {
            ...
            if (!done_reading && inputBufferIndex >= 0) {
                ...
                if (firstSampleData
                    ...
                    codec.queueInputBuffer(inputBufferIndex, 0, sampleSize, presentation_time, 0)
                    extractor.advance()
                    tot_size_read += sampleSize
    ...
    companion object {
        ...
        val supportedExtensions = arrayOf("mp3", "wav", "3gpp", "3gp", "amr", "aac", "m4a", "ogg")
